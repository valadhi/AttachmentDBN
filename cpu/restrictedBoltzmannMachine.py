...
class RBM(object):
  ...
  def reconstruct(self, dataInstances, label, steps):
    return reconstructFixedLbl(self.biases, self.testWeights, 
          dataInstances, self.activationFun, label, steps)
...
def contrastiveDivergence(data, biases, weights, activationFun, dropout,
  ...
  print "reconstructionError",reconstructionError(biases, weights, data, activationFun)
